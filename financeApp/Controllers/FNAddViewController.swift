...
class FNAddViewController: UIViewController {
    ...
    private let mainView     = FNValueInputView(frame: .zero)
    ...
    @objc func handleAcceptTap() {
        guard let value = mainView.amountField.text else { return }
        callback?(value)
    ...
    private func setupViews() {
        ...
        //MARK: - Accept Button
        self.menuView.addSubview(self.acceptButton)
        ...
        self.nameLabel.anchorCenterXToSubview(subView: self.menuView)
        ...
        //MARK: - Input View
        self.menuView.addSubview(self.mainView)
        self.mainView.anchor(top: self.nameLabel.bottomAnchor,
                             leading: self.menuView.leadingAnchor,
                             bottom: self.acceptButton.topAnchor,
                             trailing: self.menuView.trailingAnchor,
                             padding: .init(top: 16, left: 16, bottom: 16, right: 16))
    }
}

extension FNAddViewController: UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning {
